wavesongs.utils.plot
====================

.. py:module:: wavesongs.utils.plot
...
.. autoapisummary::
   ...
   wavesongs.utils.plot.Base
   wavesongs.utils.plot.Matplotlib
   wavesongs.utils.plot.Plotly
...
.. autoapisummary::
   ...
   wavesongs.utils.plot.fittings_comparison
   wavesongs.utils.plot.get_roi
   wavesongs.utils.plot.set_plotter
...
.. py:class:: Matplotlib(*args, **kwargs)
   ...
   .. py:method:: spectrogram(obj, grid = True, mode = 'max', type = '2d', auxiliar = 'none', ff = False, click = 'none', waveforme = False, save = False, legend = False, figsize = (8, 6), ylim = None)
...
.. py:class:: Plotly(height = 500, width = 700, percentage = 0, *args, **kwargs)
   ...
   .. py:method:: spectrogram(obj, type = '2d', auxiliar = 'none', mode = 'mean', waveforme = False, grid = True, ff = False, click = 'none', legend = False, ylim=None)
...
.. py:function:: fittings_comparison(time, ff, poly_deg=3, scale=0.001, verbose=True, grid=True, variable='Fundamental Frequency', unit='kHz')
